...
function calendrier()
{
    ...
    dep_j = dep_j.getDay();
    document.write('<table class="cal_calendrier" style="width:100%; height:100%" onload="opacite(document.getElementById(\'cal_body\'),20);"><tbody id="cal_body"><tr><th colspan="7">'+date_aujourdui+'</th></tr>');
